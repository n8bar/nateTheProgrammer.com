...
export const caseStudies: CaseStudy[] = [
  {
    ...
    title: 'Colorado City Fuel Distribution Manager',
    tagline:
  ...
  },
  {
    ...
    tagline:
      'A fast, glanceable drive-thru menu board and back-office, built end to end and run for two years.',
    context: 'Drive-thru smoke/vape/gift shop in Colorado City, AZ',
